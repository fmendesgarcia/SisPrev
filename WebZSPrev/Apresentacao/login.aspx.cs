    ...
    public partial class Login : System.Web.UI.Page
    {
        ...
        protected void Unnamed1_Click(object sender, EventArgs e)
        {
            ...
            if(resultado)
            {
                if(id > 0)
                {
                    List<ObjetoTransferencia.Responsavel> lista =  resp.consulta_session("usp_manutencao_responsavel", "consultar_session");
                    resp = lista[0];
                    ...
                    Session["permissao"] = resp.permissao;
                     ...
                     //Response.Write("<script>window.open ('consultaCliente.aspx','_blank');</script>");
