        ...
        <div class="row">
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    <div class="panel-heading" style="background-color: #137a81;color:white; border-color: #183b4c; ">
                    ...
                    <div class="panel-body">
                        <form role="form">
                            <fieldset>
                                ...
                                <asp:Button  class="btn btn-sm btn-info" Text="ENTRAR" style="float: right; background-color: #137a81; border-color:  #183b4c; " runat="server" OnClick="Unnamed1_Click"  />
                            </fieldset>
                        </form>
                    </div>
                </div>
